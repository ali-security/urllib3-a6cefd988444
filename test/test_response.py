...
class TestResponse:
    ...
    def test_decode_zstd_frame_variants_with_max_length(
        ...
        """
        # Only the 'zstandard' package can emit these frame layouts on
        # demand; it is always installed with the 'zstd' extra, which is
        # also what the decoder uses on Python 3.13 and earlier.
